...
musicArchivePath = os.path.join(r"D:\gdrive\media\Music", musicType, musicArchiveFileName)
...
ytDlUrl = "https://www.youtube.com/playlist?list=LL"
outputExt = "m4a"
thumbnailExt = "png"
...
def main():
    try:
        ...
        # Make sure that each file has album and artist values. Use mp3tag to add album tag if necessary
